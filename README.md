...
1. [Releases](https://github.com/Di-Is/qso-chappy/releases) から最新版を入手します
...
サンプルのクェーサースペクトル（VLT/UVES で観測された Q0329-385）が同梱されているので、
自分のデータを用意しなくても、読み込みから吸収線の当てはめまでを一通り体験できます。
チュートリアルは後から「ヘルプ > チュートリアル」でいつでもやり直せます。
...
- Windows / macOS / Linux
- Python 3.12 以降（自動で用意されるため、事前のインストールは不要です）
